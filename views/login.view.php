      ...
      <div class="flex items-center">
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            <a href="./login.view.php" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium"
              aria-current="page">Login</a>
            <a href="./register.view.php"
              class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Cadastro</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
    <form action="../index.php" method="post" name="login"
      ...
      <div class="flex flex-col w-[300px]">
        ...
        <input type="password" name="password" placeholder="*******" required minlength="8" numfmt_get_symbol>
      </div>
      <div class="flex flex-col w-[300px]">
